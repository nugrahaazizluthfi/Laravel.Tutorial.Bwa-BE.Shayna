                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    ...
                                                    if($item->transaction_status == 'SUCCESS') $badge = 'badge-success';
                                                    if($item->transaction_status == 'FAILED') $badge = 'badge-danger';
                                                @endphp
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('transactions.edit', $item->id)}}?status=FAILED"
